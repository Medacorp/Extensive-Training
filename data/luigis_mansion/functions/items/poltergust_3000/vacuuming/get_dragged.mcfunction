...
execute if score #koopa_amiibo Selected matches 1 if entity @s[scores={Pull=20..,Room=..0},gamemode=!creative] run function luigis_mansion:entities/player/pulled_damage